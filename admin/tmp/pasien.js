function cekNokaBPJS(){
    ...
    $.ajax({
        url: 'http://localhost/lite3/admin/pasien/noka_bpjs?noka='+no_peserta+'&t=1bdf2736be5c',
...
function cekNikBPJS(){
    ...
    $.ajax({
        url: 'http://localhost/lite3/admin/pasien/nik_bpjs?nik='+no_ktp+'&t=1bdf2736be5c',
    }).success(function (data) {
        var json = data,
        obj = JSON.parse(json);
        console.log(obj);
...
$(document).ready(function(){
    $.ajax({
      type: 'GET',
      url: 'http://localhost/lite3/admin/pasien/ajax?show=propinsi&t=1bdf2736be5c',
...
$(document).on('click', '.pilihpropinsi', function (e) {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://localhost/lite3/admin/pasien/ajax?show=kabupaten&kd_prop='+kd_prop+'&t=1bdf2736be5c',
    success: function(response) {
...
$(document).on('click', '.pilihkabupaten', function (e) {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://localhost/lite3/admin/pasien/ajax?show=kecamatan&kd_kab='+kd_kab+'&t=1bdf2736be5c',
    success: function(response) {
...
$(document).on('click', '.pilihkecamatan', function (e) {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://localhost/lite3/admin/pasien/ajax?show=kelurahan&kd_kec='+kd_kec+'&t=1bdf2736be5c',
    success: function(response) {
